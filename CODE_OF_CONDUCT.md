...
privately to the project maintainers through a
[GitHub private advisory](https://github.com/rezanmz/omnifin/security/advisories/new).
Reports unrelated to software vulnerabilities should begin their title with
`Code of Conduct`. All complaints will be reviewed and investigated promptly and
fairly.
