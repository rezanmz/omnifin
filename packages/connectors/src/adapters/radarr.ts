...
const radarrLibraryMovieResponseSchema = z
  .array(radarrLibraryMovieSchema)
  .max(10);
    ...
    const matches = records.filter(
      (record) =>
        ...
        (identity.imdb === null ||
          ...
          (identity.tmdb !== null &&
            (record.imdbId === null || record.imdbId === undefined))),
    );
