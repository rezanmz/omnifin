...
safe provider metadata, OIDC browser routes, RP-initiated and provider-initiated
back-channel logout, individual and account-wide local session
...
administration yet; provider-initiated front-channel logout, complete permission enforcement,
