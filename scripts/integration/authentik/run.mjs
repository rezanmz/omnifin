  ...
  try {
    ...
    const classifyBrowserFailure = ({ stderr }) => {
      ...
      const allowedStages = new Set([
        ...
        "backchannel_provider_session_cleanup",
        ...
        "backchannel_trigger",
        "backchannel_trigger_network_failure",
        "backchannel_trigger_output_missing",
        "backchannel_trigger_process_failure",
        "backchannel_trigger_provider_invalid",
        ...
        "provider_enable_invalid_response",
        "provider_enable_redirect",
        "provider_enable_response",
        "provider_enable_server_error",
        "provider_enable_unexpected_status",
        "provider_validate",
        "public_provider",
        "recovery_session",
        "role_mapping",
