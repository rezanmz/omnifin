...
const PALETTE_COMMANDS: readonly PaletteCommand[] = [
  ...
  {
    description: "Your completed and in-progress Jellyfin activity",
    group: "Navigate",
    href: "/history",
    icon: History,
    id: "viewing-history",
    keywords: ["history", "watched", "progress", "resume", "played"],
    label: "Viewing history",
    permission: "playback.history.self.manage",
  },
  {
  ...
  {
    description: "Privacy-safe authentication and operator history",
    group: "Administer",
    href: "/settings/audit",
    icon: ScrollText,
    id: "audit-trail",
    keywords: ["audit", "history", "operator", "authentication", "activity", "security"],
